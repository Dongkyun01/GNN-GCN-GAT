...
def eval_gcn(model, test_loader, edge_index, device,save_path="results/gcn.json"):
    model.eval()
    ...
    print(f"[GCN] Eval AUC: {auc:.4f} | Hit@1: {hit:.4f} | Precision: {precision:.4f} | Recall: {recall:.4f} | Best Thresh: {best_threshold:.2f}")
